...
def scrabble(word):
    """
    Функция присвоения очков
    :param word: Поступают слова (можно использовать любой регистр)
    :return: Выполняется присвоение очков
    """
    points = {1: 'АВЕЁИНОРСТ',
                 2: 'ДКЛМПУ',
                 3: 'БГЬЯ',
                 ...
                 15: 'Ъ'}
    word = word.upper()
    points = sum([k for item in word for k, v in points.items() if item in v])
    return points
